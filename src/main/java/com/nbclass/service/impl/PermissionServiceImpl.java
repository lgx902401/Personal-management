...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Override
    public List<Permission> findAllPerms(Permission permission) {
        return permissionMapper.findAllPerms(permission);
    }
    ...
    @Override
    public  List<Permission> findByPermissionId(String permissionId) {
